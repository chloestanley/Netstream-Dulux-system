        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Guard_Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Guard_SecurityCard_No = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Driver_Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Driver_SecurityCard_No = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    SendToControlRoom = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Scan_Images", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ScanImageId = table.Column<int>(type: "int", nullable: false),
                    Comments = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReturnCreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Returns", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Returns_Scan_Images_ScanImageId",
